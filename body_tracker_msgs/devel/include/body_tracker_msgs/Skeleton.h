...
struct Skeleton_
{
  ...
  Skeleton_(const ContainerAllocator& _alloc)
    ...
    , joint_position_right_hand_proj(_alloc)  {
  (void)_alloc;
    }
  ...
  _joint_position_right_hand_type joint_position_right_hand;
   ...
   typedef  ::geometry_msgs::Point32_<ContainerAllocator>  _joint_position_right_hand_proj_type;
  _joint_position_right_hand_proj_type joint_position_right_hand_proj;
...
struct MD5Sum< ::body_tracker_msgs::Skeleton_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x3e558fe5e547cebaULL;
  static const uint64_t static_value2 = 0x8c58c67a74015e45ULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::body_tracker_msgs::Skeleton_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.joint_position_right_hand_proj);
    }
...
struct Printer< ::body_tracker_msgs::Skeleton_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::body_tracker_msgs::Skeleton_<ContainerAllocator>& v)
  {
    ...
    s << indent << "joint_position_right_hand_proj: ";
    s << std::endl;
    Printer< ::geometry_msgs::Point32_<ContainerAllocator> >::stream(s, indent + "  ", v.joint_position_right_hand_proj);
  }
};
