...
(cl:defclass <Skeleton> (roslisp-msg-protocol:ros-message)
  ((body_id
   ...
   (joint_position_right_hand_proj
    :reader joint_position_right_hand_proj
    :initarg :joint_position_right_hand_proj
    :type geometry_msgs-msg:Point32
    :initform (cl:make-instance 'geometry_msgs-msg:Point32)))
)
...
(cl:ensure-generic-function 'joint_position_right_hand_proj-val :lambda-list '(m))
(cl:defmethod joint_position_right_hand_proj-val ((m <Skeleton>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader body_tracker_msgs-msg:joint_position_right_hand_proj-val is deprecated.  Use body_tracker_msgs-msg:joint_position_right_hand_proj instead.")
  (joint_position_right_hand_proj m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Skeleton>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'joint_position_right_hand_proj) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Skeleton>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'joint_position_right_hand_proj) istream)
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Skeleton>)))
  ...
  "3e558fe5e547ceba8c58c67a74015e45")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Skeleton)))
  "Returns md5sum for a message object of type 'Skeleton"
  "3e558fe5e547ceba8c58c67a74015e45")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Skeleton>))
  (cl:+ 0
     ...
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'joint_position_right_hand_proj))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Skeleton>))
  ...
  (cl:list 'Skeleton
    ...
    (cl:cons ':joint_position_right_hand_proj (joint_position_right_hand_proj msg))
))
