...
class Skeleton {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.joint_position_right_hand_proj = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('joint_position_right_hand_proj')) {
        this.joint_position_right_hand_proj = initObj.joint_position_right_hand_proj
      }
      else {
        this.joint_position_right_hand_proj = new geometry_msgs.msg.Point32();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [joint_position_right_hand_proj]
    bufferOffset = geometry_msgs.msg.Point32.serialize(obj.joint_position_right_hand_proj, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [joint_position_right_hand_proj]
    data.joint_position_right_hand_proj = geometry_msgs.msg.Point32.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static md5sum() {
    ...
    return '3e558fe5e547ceba8c58c67a74015e45';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.joint_position_right_hand_proj !== undefined) {
      resolved.joint_position_right_hand_proj = geometry_msgs.msg.Point32.Resolve(msg.joint_position_right_hand_proj)
    }
    else {
      resolved.joint_position_right_hand_proj = new geometry_msgs.msg.Point32()
    }
